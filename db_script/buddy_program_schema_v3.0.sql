...
DROP TABLE IF EXISTS BUDDY_PROGRAM;
...
CREATE TABLE EMPLOYEE (
	...
	role VARCHAR(50) -- New column added for role
);
...
INSERT INTO EMPLOYEE (employee_id, name, email, contact, location, band, role) VALUES
('100001', 'Aarav Kumar', 'aarav.kumar@ust.com', '9876543210', 'Bangalore', 'A1','junior_buddy'),
('100002', 'Vivaan Sharma', 'vivaan.sharma@ust.com', '9123456789', 'Trivandrum', 'B2','junior_buddy'),
('100003', 'Arjun Patel', 'arjun.patel@ust.com', '9345678901', 'Chennai', 'C1','senior_buddy'),
('100004', 'Vivaan Iyer', 'vivaan.iyer@ust.com', '9988776655', 'Bangalore', 'A2','junior_buddy'),
('100005', 'Ishaan Reddy', 'ishaan.reddy@ust.com', '9900112233', 'Trivandrum', 'B1','junior_buddy'),
('100006', 'Rohan Menon', 'rohan.menon@ust.com', '9911223344', 'Chennai', 'C2','admin');
